        ...
        try{
            ...
            foreach($json AS $seasonStanding){
                $values = array(
                    ...
                    "season_current_rating"        => isset($seasonStanding["current"]["rating"]) ? $seasonStanding["current"]["rating"] : null,
            ...
            foreach($seasons AS $season){
                ...
                foreach($season->divisions as $division){
                    $divisionValues = array(
                        ...
                        'division_large_icon'   => isset($division->large_icon) ? $division->large_icon : null,
                        'division_small_icon'   => isset($division->small_icon) ? $division->small_icon : null,
